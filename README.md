...
From a web server development perspective Node has a number of benefits:
  ...
  * Great performance! Node was designed to optimize throuhgput and scalability in web applications and is a good solution for many common web-development problems (e.g. real-time web applications).
